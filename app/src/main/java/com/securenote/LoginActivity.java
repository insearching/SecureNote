...
public class LoginActivity extends Activity implements FingerprintViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!keyguardManager.isKeyguardSecure()) {
            ...
            new AlertDialog.Builder(this)
                    .setTitle(R.string.add_fingerprint)
                    .setMessage(
                            R.string.setup_fingerprint)
                    .setNegativeButton(R.string.cancel, null)
                    .setPositiveButton(R.string.go_to_settings,
                            (dialog, which) -> startSecuritySettings())
                    .show();
            return;
        }

        // Now the protection level of USE_FINGERPRINT permission is normal instead of dangerous.
        // See http://developer.android.com/reference/android/Manifest.permission
        // .html#USE_FINGERPRINT
        ...
        if (!fingerprintManager.hasEnrolledFingerprints()) {
            ...
            new AlertDialog.Builder(this)
                    .setTitle(R.string.add_fingerprint)
                    .setMessage(
                            R.string.add_fingerprint_settings)
                    .setNegativeButton(R.string.cancel, null)
                    .setPositiveButton(R.string.go_to_settings,
                            (dialog, which) ->
                                    startActivityForResult(
                                            new Intent(Settings.ACTION_SECURITY_SETTINGS), 0))
                    .show();
    ...
    protected void onResume() {
        ...
        try {
            ...
            showTouchDialog(defaultCipher, DEFAULT_KEY_NAME);
...
//            v.setText(Base64.encodeToString(encrypted, 0 /* flags */));
    ...
    private void showTouchDialog(Cipher cipher, String keyName) {
